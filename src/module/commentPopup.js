...
const commentsEndpoint = 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/VWIl4IKk3y3x1neav2bU/comments';
  ...
  fetchMovieData(movieId).then((data) => {
    ...
    form.addEventListener('submit', (e) => {
      ...
      addComment({
        ...
        updateTotalCommentsCount(movieId); // Update total comments count first
        showComments(movieId); // Display comments after updating total count
        form.reset();
      });
    });

    showComments(movieId); // Display comments initially
  });
